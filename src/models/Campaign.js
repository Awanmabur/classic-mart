...
const schema=new Schema({
 publicId:{type:String,required:true,unique:true,immutable:true,index:true},scope:{type:String,enum:['seller','marketplace'],default:'seller',index:true},systemManaged:{type:Boolean,default:false,index:true},ownerUserId:{type:Schema.Types.ObjectId,ref:'User',required(){return this.scope!=='marketplace';},index:true},storeId:{type:Schema.Types.ObjectId,ref:'Store',required(){return this.scope!=='marketplace';},index:true},country:{type:String,required:true,uppercase:true,index:true},name:{type:String,required:true,trim:true,maxlength:140},

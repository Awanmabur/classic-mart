...
const itemSchema=new Schema({productPublicId:{type:String,required:true},variantPublicId:{type:String,required:true},quantity:{type:Number,required:true,min:1,max:9999}},{_id:false});

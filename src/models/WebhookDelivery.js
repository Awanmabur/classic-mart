...
const schema=new Schema({
 ...
 status:{type:String,enum:['queued','delivered','failed','dead'],default:'queued',index:true},nextAttemptAt:{type:Date,default:Date.now,index:true},lastAttemptAt:{type:Date,default:null},responseStatus:{type:Number,default:0},responseHash:{type:String,default:''},errorMessage:{type:String,trim:true,maxlength:500,default:''},deliveredAt:{type:Date,default:null}
},{timestamps:true});
